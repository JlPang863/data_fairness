...
CUDA_VISIBLE_DEVICES=0 nohup python3 run_celeba.py --method plain  --lmd 0.0 --mu 1.0  --warm_step -1 --conf no_conf  --metric dp --label_ratio 0.05 --val_ratio 0.1 --strategy 2 --remove_pos --sel_round 5 --remove_pos