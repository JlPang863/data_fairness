...
parser.add_argument('--without_label', default=False, action="store_true") 
...
parser.add_argument('--half_ablation', default=False, action="store_true") 
...
EXP = 'exps'
RUN = args.runs
META_MODEL_SEED, META_TRAIN_SEED, SEED_INCR = 424, 42424, 4242424
EP_STEPS = 200  
DATA_DIR = '/data2/data'
EXPS_DIR = ROOT + '/exps'
