...
CUDA_VISIBLE_DEVICES=0 python3 run_celeba_fair_learn.py --method dynamic_lmd  --lmd 0.0 --mu 1.0  --warm_epoch -1 --conf peer  --metric dp --label_ratio 0.02 --val_ratio 0.1 --strategy 2 --sel_round 5 --remove_pos --exp 2 --conf_method V 