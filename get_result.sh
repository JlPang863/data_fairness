...
do
    ...
    do
        for STG in $strategy
        do
            echo $VR\_$MYCONF\_exp$MYEXP\_$CM
            ...
            cat ./logs/fair_train/s$STG\_dp_02_new256_100round_val_$VR\_$MYCONF\_exp$MYEXP\_$CM.log | grep "98.79" | grep "test" | awk '{ print $19, $26 }'
